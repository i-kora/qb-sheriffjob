    ...
    methods: {
        OpenCameras(label, connected, cameraId, time) {
            ...
            if (connected) {
                ...
                this.cameraLabel = "ERROR #400: PETICION MALFORMADA"
                this.connectLabel = "CONNEXION FALLIDA";
...
HeliCam.UpdateVehicleInfo = function(data) {
    ...
    $(".heli-model").find("p").html("MODELO: " + data.model);
    $(".heli-plate").find("p").html("MATRICULA: " + data.plate);
