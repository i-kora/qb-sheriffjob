local Translations = {
    ...
    info = {
        ...
        blip_text = 'Alerta de la sheriff - %{text}',
    ...
    menu = {
        garage_title = 'Vehiculos sheriff',
        close = '⬅ Cerrar menu',
        impound = 'Vehiculos embargados',
        pol_impound = 'Embargos de sheriff',
        pol_garage = 'Garage de sheriff',
        pol_armory = 'Armeria sheriffl',
    },
    email = {
    ...
    commands = {
        place_spike = 'Colocar pinchos (sheriff solo)',
        ...
        cuff_player = 'Esposar jugador (Solo sheriff)',
        escort = 'Escolta',
        callsign = 'Dar una asignacion',
        clear_casign = 'Borrar cona de asignaciones (Solo sheriff)',
        ...
        softcuff = 'Esposar suave (Solo sheriff)',
        camera = 'Ver cámara de seguridad (solo policía)',
        flagplate = 'Marcar una matricula (Solo sheriff)',
        unflagplate = 'Desmarcar una matricula (Solo polcia)',
        plateinfo = 'Buscar matricula (solo la policía)',
        depot = 'Embargar con precio (Solo la sheriff)',
        impound = 'Embargar un coche (Solo la sheriff)',
        paytow = 'Paga para remolcador (Solo la sheriff)',
        paylawyer = 'Abogado de pago (Police, Judge Only)',
        anklet = 'Adjuntar rastreo de la tobillera (Solo la sheriff)',
        ankletlocation = 'Obtenga la ubicación de una tobillera de personas',
        removeanklet = 'Eliminar la tobillera de seguimiento (Solo la sheriff)',
        drivinglicense = 'Aprovechar la licencia de conducir (Solo la sheriff)',
        takedna = 'Tome una muestra de ADN de una persona (se necesita bolsa de evidencia vacía) (Solo la sheriff)',
        police_report = 'Reporte sheriffl',
